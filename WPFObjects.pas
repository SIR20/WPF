...
var
  ...
  OnMouseDown: procedure(x, y: real; mousebutton, ClCount: integer);
...
var
  ColorsDict := new Dictionary<GColor, SolidColorBrush>;
...
begin
  ...
  if OnMouseDown <> nil then  
    OnMouseDown(p.x, p.y, mb, e.ClickCount);
end;
...
var
  LastUpdatedTimeWPF := new System.TimeSpan(integer.MinValue);
